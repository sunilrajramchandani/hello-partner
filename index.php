...
<head>
	<title>Archie Arintok</title>
		...
		<link rel="stylesheet" type="text/css" href="csssss.css">
</head>
<body>
<?php include('nabar.php'); ?>
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
			...
			<p class="h3 text-center text-muted">The Heartbreak Kid</p>
			<img src='archie.png' class="img-responsive">
			<a href = "#About"><span class="glyphicon-chevron-down"></span></a>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
		</div>
	</div>
